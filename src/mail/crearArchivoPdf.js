...
async function CrearPdf(form, fecha, hora, ruta) {
  ...
  // Escribir el contenido HTML en la página
  await page.setContent(`<html xmlns="http://www.w3.org/1999/xhtml">
                                                                                  ...
                                                                                  <tr>
                                                                                      <td class="element-td text-element-td" style="overflow-wrap: break-word; word-break: break-word;">
                                                                                          <div class="text_container newsletter-main-content" style="padding: 10px; border-width: 0px; border-color: rgb(0, 0, 0); border-radius: 0px; border-style: unset; color: rgb(0, 0, 0); font-family: Arial, Helvetica, sans-serif, Arial, Helvetica, sans-serif; line-height: 1.3; font-size: 16px;">
                                                                                              <p style="text-align: center; margin: 0px;"><span style="font-size: 24px;"><span style="color: rgb(138, 134, 104);"><span style="font-family: &quot;Bookman Old Style&quot;, serif, Arial, Helvetica, sans-serif;">${
                                                                                                form.caso ==
                                                                                                'Transito'
                                                                                  ...
                                                                                  <tr>
                                                                                      <td class="element-td text-element-td" style="overflow-wrap: break-word; word-break: break-word;">
                                                                                          <div class="text_container newsletter-main-content" style="padding: 40px; border-width: 0px; border-color: rgb(0, 0, 0); border-radius: 0px; border-style: unset; color: rgb(0, 0, 0); font-family: Arial, Helvetica, sans-serif, Arial, Helvetica, sans-serif; line-height: 1.3; font-size: 16px;">
                                                                                              <p style="text-align: center; margin: 0px;"><span style="font-size: 12px;"><span style="color: rgb(138, 134, 104);"><span style="font-family: &quot;Bookman Old Style&quot;, serif, Arial, Helvetica, sans-serif;">Placa:  ${
                                                                                                form.placa
                                                                                              }</span></span></span></p>
                                                                                              <p style="text-align: center; margin: 0px;"><span style="font-size: 12px;"><span style="color: rgb(138, 134, 104);"><span style="font-family: &quot;Bookman Old Style&quot;, serif, Arial, Helvetica, sans-serif;">Conductor:  ${
                                                                                                form.conductor
                                                                                              } CC.${
    form.cedula
  }</span></span></span></p>
                                                                                              <p style="text-align: center; margin: 0px;"><span style="font-size: 12px;"><span style="color: rgb(138, 134, 104);"><span style="font-family: &quot;Bookman Old Style&quot;, serif, Arial, Helvetica, sans-serif;">Producto/Materia Prima:  ${
                                                                                                form.materiaPrimaProducto
                                                                                              }</span></span></span></p>
                                                                                              <p style="text-align: center; margin: 0px;"><span style="font-size: 12px;"><span style="color: rgb(138, 134, 104);"><span style="font-family: &quot;Bookman Old Style&quot;, serif, Arial, Helvetica, sans-serif;">Planta:  ${
                                                                                                form.planta
                                                                                              }</span></span></span></p>
                                                                                              <p style="text-align: center; margin: 0px;"><span style="font-size: 12px;"><span style="color: rgb(138, 134, 104);"><span style="font-family: &quot;Bookman Old Style&quot;, serif, Arial, Helvetica, sans-serif;">Cliente/Proveedor:  ${
                                                                                                form.clienteProveedor
                                                                                              }</span></span></span></p>
                                                                                              <p style="text-align: center; margin: 0px;"><span style="font-size: 12px;"><span style="color: rgb(138, 134, 104);"><span style="font-family: &quot;Bookman Old Style&quot;, serif, Arial, Helvetica, sans-serif;">Origen:  ${
                                                                                                form.origenDestino
                                                                                              }</span></span></span></p>
                                                                                              <p style="text-align: center; margin: 0px;"><span style="font-size: 12px;"><span style="color: rgb(138, 134, 104);"><span style="font-family: &quot;Bookman Old Style&quot;, serif, Arial, Helvetica, sans-serif;">Origen:  ${
                                                                                                form.destino
                                                                                              }</span></span></span></p>
                                                                                              <p style="text-align: center; margin: 0px;"><span style="font-size: 12px;"><span style="color: rgb(138, 134, 104);"><span style="font-family: &quot;Bookman Old Style&quot;, serif, Arial, Helvetica, sans-serif;">Transportadora:  ${
                                                                                                form.transportadora
                                                                                              }</span></span></span></p>
                                                                                              ...
                                                                                              <p style="text-align: center; margin: 0px;">&nbsp;</p>
                                                                                              <p style="text-align: center; margin: 0px;"><span style="color: rgb(138, 134, 104); font-family: &quot;Bookman Old Style&quot;, serif, Arial, Helvetica, sans-serif;"><span style="font-size: 12px;">Bruto: ${
                                                                                                form.bruto
                                                                                              }</span></span></p>
                                                                                              <p style="text-align: center; margin: 0px;"><span style="color: rgb(138, 134, 104); font-family: &quot;Bookman Old Style&quot;, serif, Arial, Helvetica, sans-serif;"><span style="font-size: 12px;">Tara: ${
                                                                                                form.tara
                                                                                              }</span></span></p>
                                                                                              <p style="text-align: center; margin: 0px;"><span style="color: rgb(138, 134, 104); font-family: &quot;Bookman Old Style&quot;, serif, Arial, Helvetica, sans-serif;"><span style="font-size: 12px;">Neto: ${
                                                                                                form.neto
                                                                                              }</span></span></p>
                                                                          ...
                                                                          <table class="component text-component text-desktop textfaabb0ba" data-component-type="text" cellspacing="0" cellpadding="0" width="600" style="clear: both; background-color: rgb(255, 255, 255);">
                                                                              <tbody>
                                                                                  <tr>
                                                                                      <td class="element-td text-element-td" style="overflow-wrap: break-word; word-break: break-word;">
                                                                                          <div class="text_container newsletter-main-content" style="padding: 10px; border-width: 0px; border-color: rgb(0, 0, 0); border-radius: 0px; border-style: unset; color: rgb(0, 0, 0); font-family: Arial, Helvetica, sans-serif, Arial, Helvetica, sans-serif; line-height: 1.3; font-size: 16px;">
                                                                                              <p style="text-align: center; margin: 0px;"><span style="font-size: 18px;"><span style="color: rgb(138, 134, 104);"><span style="font-family: &quot;Bookman Old Style&quot;, serif, Arial, Helvetica, sans-serif;">Operario: ${
                                                                                                form.operario
                                                                                              }</span></span></span></p>
  ...
  const rutaArchivo = `${ruta}${
    form.caso == 'Transito'
      ? `${form.placa}_VehículoEnTransito_${fecha}_${hora}.pdf`
      : form.caso == 'Despacho'
      ? `${form.placa}_DespachoDeProducto_${fecha}_${hora}.pdf`
      : `${form.placa}_IngresoDeMateriaPrima_${fecha}_${hora}.pdf`
  }`;
  const name = `${
    form.caso == 'Transito'
      ? `${fecha}_${hora}.csv`
  ...
  if (form.caso == 'Transito') {
    const rutaArchivocsv =
      './csv' +
      `${
        form.caso == 'Transito'
          ? `/transito/${fecha}_${hora}.csv`
          : form.caso == 'Despacho'
          ? `/despacho/${fecha}_${hora}.csv`
          : `/ingresoMateria/${fecha}_${hora}.csv`
      }`;
    ...
    const csvWriter = createCsvWriter({
      ...
      header: [
        { id: 'PCRCarga', title: 'PCRCarga' },
        { id: 'placa', title: 'Placa' },
        { id: 'conductor', title: 'Conductor' },
        { id: 'cedula', title: 'Cedula' },
        { id: 'producto', title: 'Producto' },
        { id: 'planta', title: 'Planta' },
        { id: 'cliente', title: 'Cliente/Proveedor' },
        { id: 'OrigenDestino', title: 'Destino/Origen' },
        { id: 'transportadora', title: 'Transportadora' },
        { id: 'fechaPesoVacio', title: 'Fecha_Peso_Vacio' },
        { id: 'horaPesoVacio', title: 'Hora_Peso_Vacio' },
        { id: 'fechaPesoLleno', title: 'Fecha_Peso_Lleno' },
        { id: 'horaPesoLleno', title: 'Hora_Peso_Lleno' },
        { id: 'bruto', title: 'Bruto' },
        { id: 'tara', title: 'Tara' },
        { id: 'neto', title: 'Neto' },
        { id: 'noTiquete', title: 'No_Tiquete' },
        { id: 'noSello', title: 'No_Sello' },
        { id: 'noR', title: 'No_R' },
        { id: 'noContainer', title: 'N_Contenedor' },
    ...
    const records = [
      {
        ...
        cedula: form.cedula,
        producto: form.materiaPrimaProducto,
        planta: form.planta,
        cliente: form.clienteProveedor,
        OrigenDestino: form.origenDestino,
        transportadora: form.transportadora,
        fechaPesoVacio: form.fechaPesoVacio,
        horaPesoVacio: form.horaPesoVacio,
        fechaPesoLleno: form.fechaPesoLleno,
        horaPesoLleno: form.horaPesoLleno,
        bruto: form.bruto,
        tara: form.tara,
        neto: form.neto,
        noTiquete: form.noTiquete,
        noSello: form.no_Sello,
        noR: form.no_R,
        noContainer: form.no_Contenedor,
        operario: form.operario,
        observaciones: form.observaciones,
        Filename: `3PLMADRIDCOL_${rutaArchivocsv}`,
      },
    ];
    ...
    return { rutaArchivo, name, rutaArchivocsv };
  } else {
    const rutaArchivocsv =
      './csv' +
      `${
